...
public class CreateTableStatement extends SchemaAlteringStatement
{
    ...
    public CFMetaData getCFMetaData()
    {
        return metadataBuilder()
                .withPartitioner(FBUtilities.newPartitioner(properties.properties.getSimple(CFProperties.PARTITIONER_CLASS)))
                .build()
                .params(params);
    }
    ...
    public static class RawStatement extends CFStatement
    {
        ...
        public ParsedStatement.Prepared prepare() throws RequestValidationException
        {
            if (StringUtils.isEmpty(keyspace())) {
                this.prepareKeyspace(properties.properties.getSimple(CFProperties.KEYSPACE_NAME));
            }

            return prepare(Types.none());
        }
        ...
        public ParsedStatement.Prepared prepare(Types udts) throws RequestValidationException
        {
            ...
            //Todo: this is a hack
            stmt.properties.properties.properties.putAll(properties.properties.properties);
